	...
	public static void main(String[] args) throws IOException, SAXException, ParserConfigurationException {
		...
		DefaultHandler h = new DefaultHandler() {
			...
			public void characters(char ch[], int start, int length) throws SAXException {
				if (handler_01) {System.out.println(TestDataStorage.getTC()[0] + new String(ch, start, length)); handler_01 = false;}
				if (handler_02) {System.out.println(TestDataStorage.getTC()[1] + new String(ch, start, length)); handler_02 = false;}
				if (handler_03) {System.out.println(TestDataStorage.getTC()[2] + new String(ch, start, length)); handler_03 = false;}
				if (handler_04) {System.out.println(TestDataStorage.getTC()[3] + new String(ch, start, length)); handler_04 = false;}
				if (handler_05) {System.out.println(TestDataStorage.getTC()[4] + attribute_count); handler_05 = false;}
			}
		};
		p.parse(url, h);
	}
